...
<Steps>
  ...
  <Step>
    ### Capture current performance for each user journey [#capture-performance]

    <img
      title="Capture current performance for each user journey"
      alt="Capture current performance for each user journey"
